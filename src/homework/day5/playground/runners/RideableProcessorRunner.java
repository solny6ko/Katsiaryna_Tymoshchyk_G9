...
public class RideableProcessorRunner {
    public static void main(String[] args) {
        ...
        Car bCar = new Car(223, "Lada Car");
        rideableProcessor.runRideable(bCar, "NOWHERE");

        Moped bMoped = new Moped(3452, "Honda EM1 837 Moped");
        rideableProcessor.runRideable(bMoped, "EVERYWHERE");
