...
//        Flyable и Rideable это интерфейсы, а не классы, для которых заимплеменчен интерфейс Transportable
...
//        transportableProcessor.runTransportable(rideableMotorbike);
        ...
        Motorbike bMotorbike = new Motorbike(12, "Suzuki GSX-R1000 Motorbike");
        transportableProcessor.runTransportable(bMotorbike, 23, 242);
        Moped bMoped = new Moped(12, "Honda EM1 Moped");
        transportableProcessor.runTransportable(bMoped, 93, 7);
    }
}
